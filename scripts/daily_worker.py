...
SHOGUN_DIR = Path("/home/kirk/Madlab/Clean-Live/Shogun")
...
def execute_task(task):
    ...
    if task_id == "INFRA-01":
        ...
        proc = subprocess.Popen(
            [
                "/home/kirk/Madlab/Clean-Live/Shogun/venv/bin/python",
        ...
        success, out = run_command("/home/kirk/Madlab/Clean-Live/Shogun/venv/bin/python -c \"from database.manager import db; print('DB OK')\"")
        if success:
