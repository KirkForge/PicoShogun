...
**SecDev Supply Chain Scanner** — a deterministic injection detection engine that runs locally, produces verifiable results, and integrates into CI/CD.
...
- REST API endpoint for SecDev platform
