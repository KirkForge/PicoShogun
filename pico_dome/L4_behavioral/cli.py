...
Usage:
    python -m pico_dome.L4_behavioral.cli analyze --trace results.json
    python -m pico_dome.L4_behavioral.cli analyze --trace results.json --baseline npm-install
    python -m pico_dome.L4_behavioral.cli analyze --profile profile.json
    python -m pico_dome.L4_behavioral.cli baselines
"""
