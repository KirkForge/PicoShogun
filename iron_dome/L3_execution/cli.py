...
Usage:
    ...
    python -m iron_dome.L3_execution.cli run -- ./command
    python -m iron_dome.L3_execution.cli policy --output default.yml
    python -m iron_dome.L3_execution.cli generate-policy --from-l2 results.json --output sandbox.yml
"""
