#!/usr/bin/env python3
"""
DEPRECATED: This module is superseded by services/orchestrator.py (EnhancedOrchestrator).
...
class ProjectRunner:
    ...
    def run(self, project_id: str) -> dict:
        ...
        try:
            cmd = [sys.executable, str(main_script)] if main_script.suffix == ".py" else ["bash", str(main_script)]
...
warnings.warn("master.py is deprecated — use api/server.py instead", DeprecationWarning, stacklevel=2)
