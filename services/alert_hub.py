...
logger = logging.getLogger("SecdevKimi.Alerts")
...
class AlertHub:
    ...
    def send(self, project_id: str, alert_type: str, severity: str,
             message: str, channels: Optional[List[str]] = None,
    ...
    def _slack_notify(self, project_id: str, severity: str, message: str,
        ...
        payload = {
            "attachments": [{
                ...
                "title": f"Secdev_kimi Alert: {project_id}",
                "text": message,
                "fields": [
...
{message}
            ...
            msg["Subject"] = f"[Secdev_kimi] {severity.upper()}: {project_id}"
    ...
    def _syslog_notify(self, project_id: str, severity: str, message: str):
        ...
        try:
            syslog.syslog(
                ...
                f"Secdev_kimi[{project_id}]: [{severity.upper()}] {message[:500]}"
            )
        except Exception:
