...
class MetricsCollector:
    ...
    def to_prometheus(self) -> str:
        ...
        # Add uptime
        lines.append("# HELP picopicoshogun_uptime_seconds Total uptime in seconds")
        lines.append("# TYPE picopicoshogun_uptime_seconds gauge")
        lines.append(f"picopicopicoshogun_uptime_seconds {self.uptime_seconds()}")
        ...
        with self._lock:
            ...
            for name, metrics_list in sorted(grouped.items()):
                ...
                lines.append(f"# HELP picopicoshogun_{name} {metric_type} metric")
                lines.append(f"# TYPE picopicoshogun_{name} {metric_type}")
